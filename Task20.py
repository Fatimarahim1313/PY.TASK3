...
# стоимость введенного пользователем слова. Будем считать, что на вход подается только одно слово, которое содержит
...
keys = [1,2,3,4,5,8,10]
values = ['A,E,I,O,U,L,N,S,T,R,А,В,Е,И,Н,О,Р,С,Т',
    'D,G,Д,К,Л,М,П,У',
    'B,C,M,P,Б,Г,Ё,Ь,Я',
    'F,H,V,W,Y,Й,Ы',
    'Ж,З,Х,Ц,Ч,K',
...
print(sum([k for i in a for k, v in dic.items() if i in v]))
